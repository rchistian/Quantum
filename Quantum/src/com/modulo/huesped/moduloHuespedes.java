...
public class moduloHuespedes extends VerticalLayout  implements Serializable{
	...
	public void initComponentes() {
        ...
        BtoNuevo.addClickListener(new Button.ClickListener() {
     	...
     	ByosFormularioTab01_01.setTipoCampo("VencimientoDoc", "FechaHora");             
    ...
    public void procesoFicha() {
    	...
    	if (xNumeroDocumento!=null && !xNumeroDocumento.equals("")) {
    		new moduloReserva01(xNumeroDocumento).openWindows();
    	}
    }
	               ...
	               public void buttonClick(ClickEvent event) {         	
	                  try { 
	            	        ...
	            	        if(AL.size()>0){
	                           ...
	                           dwb.cerrarWindow();
	                           if(AbrirWindows) {
	                        	   new moduloReserva01(ClaseHuespedes.getNumeroDocumento()).openWindows();
	                           }
	            	        }
