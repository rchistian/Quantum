...
/*63*/        "RedSocial10=?"; 
    ...
    public void ActualizarDatos(tblHuespedes tbl, PreparedStatement pstmt) throws SQLException {
	      ...
	      pstmt.setString(5,tbl.Apellidos);
	 	  ...
	 	  pstmt.setDate(8,tbl.FechaNacimiento);
	 	  ...
	 	  pstmt.setDate(15,tbl.VencimientoDoc);
	 	  ...
	 	  pstmt.setDate(30,tbl.SSFechaAlta);
	      ...
	      pstmt.setDate(54,tbl.UltimaEstadia);
	 	  pstmt.setString(55,tbl.Amistad);
	  	  pstmt.setDate(56,tbl.UltimaEstadiaAmistad);
