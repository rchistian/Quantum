...
import com.modulo.huesped.moduloHuespedes;
import com.modulo.huesped.moduloHuespedesDetalle;
import com.modulo.reserva.moduloReserva01;
import com.modulo.usuarios.moduloUsuarios;



public class ByosMenuCircularHuespedes extends VerticalLayout implements Serializable{   
    ...
    public ByosMenuCircularHuespedes(){
    	    	
        subwindow = new Window("Menu Huespedes");
        ...
        btoOP01.setIcon(ByosImagenes.icon[123]);
    ...
    private void btoOP01_Click() {
    	new moduloHuespedes().openWindows();;
    }

    private void btoOP10_Click() {
    	moduloHuespedes Huespedes = new moduloHuespedes();
    	Huespedes.procesoListar(true);
    }
