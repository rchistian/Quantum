...
public class ByosMenuCircularUsuarios  extends VerticalLayout implements Serializable{   
    ...
    public ByosMenuCircularUsuarios(){
        ...
        btoOP01.setIcon(ByosImagenes.icon[121]);
